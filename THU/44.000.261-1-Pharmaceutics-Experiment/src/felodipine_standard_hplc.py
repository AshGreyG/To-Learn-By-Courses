...
# felodipine, which will be used to analysis the solubility of API, physical
...
def felodipine_standard_hplc(output: str) -> None :
    ...
    plt.xlabel("Concentration of felodipine (μg⋅mL⁻¹)")
...
def main() -> None :
    output = input().strip()
    felodipine_standard_hplc(output)
